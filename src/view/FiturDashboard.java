...
public class FiturDashboard extends javax.swing.JPanel {
    ...
    public FiturDashboard() {
        initComponents();
        total_produk.setText("0");
        total_trans.setText("0");
    ...
    private void tampilDashboard(){
        try {
            String queryP = "SELECT COUNT(*) AS total_produk FROM produk";
            PreparedStatement psp = conn.prepareStatement(queryP);
            ResultSet rsp = psp.executeQuery();

            if (rsp.next()) {
                int totalProduk = rsp.getInt("total_produk");
                total_produk.setText(String.valueOf(totalProduk)); 
            }
            
            String queryT = "SELECT COUNT(*) AS total_trx FROM transaksi";
            PreparedStatement pst = conn.prepareStatement(queryT);
            ResultSet rst = pst.executeQuery();
            
            if(rst.next()){
                int totalTrans = rst.getInt("total_trx");
                total_trans.setText(String.valueOf(totalTrans));
            }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 60, -1));

        total_produk.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        total_produk.setForeground(new java.awt.Color(255, 102, 0));
        total_produk.setText("0");
        jPanel2.add(total_produk, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 50, 30, -1));
        ...
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 29, -1, -1));
        ...
        total_trans.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        total_trans.setForeground(new java.awt.Color(102, 204, 0));
        total_trans.setText("0");
